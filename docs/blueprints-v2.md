...
| **ignoreIfSkipped** | `true`/`false` | — | `false` | **x** | If set to `true`, the value will be skipped in the summary table and value files when its skipped from prompts using promptIf. |
