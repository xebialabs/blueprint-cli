...
const (
	FlagXldUrl        = "xl-deploy-url"
	FlagXldUser       = "xl-deploy-username"
	FlagXldPass       = "xl-deploy-password"
	FlagXldAuthMethod = "xl-deploy-authmethod"

	FlagXlrUrl        = "xl-release-url"
	FlagXlrUser       = "xl-release-username"
	FlagXlrPass       = "xl-release-password"
	FlagXlrAuthMethod = "xl-release-authmethod"

	ViperKeyXLDUrl        = "xl-deploy.url"
	ViperKeyXLDUsername   = "xl-deploy.username"
	ViperKeyXLDPassword   = "xl-deploy.password"
	ViperKeyXLDAuthMethod = "xl-deploy.authmethod"
