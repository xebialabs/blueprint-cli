...
const (
	...
	AnswerFileFromConfigMap       = "config_map_answer_file.yaml" // answers form k8s config map
	GeneratedAnswerFile           = "generated_answers.yaml"      // finally generated by xl-infra blueprint and xl-up blueprint
	TempAnswerFile                = "temp_answer_file_auto.yaml"  // answer file with licence and keystore info updated or merge of cm_answer_file_auto & temp_answer_file_auto
