...
const (
	...
	GeneratedAnswerFile           = "cm_answer_file_auto.yaml"    // generated by xl-infra blueprint
	GeneratedFinalAnswerFile      = "generated_answers.yaml"      // answer file saved finally
	TempAnswerFile                = "temp_answer_file_auto.yaml"  // answer form xl-up
	MergedAnswerFile              = "merged_answer_file.yaml"     // merge of cm_answer_file_auto & temp_answer_file_auto
