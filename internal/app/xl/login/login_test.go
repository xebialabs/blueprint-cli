	...
	tests := []struct {
		...
		{"validInput", "valid input with type 1 and ssl 1", defSrvName, vldSrvType1,
			...
			&servers.Server{
				...
				Ssl:      false,
				Metadata: map[string]string{
					servers.XldAppHomeDirKey: servers.DefaultXld.Metadata[servers.XldAppHomeDirKey],
					servers.XldCfgHomeDirKey: servers.DefaultXld.Metadata[servers.XldCfgHomeDirKey],
					servers.XldEnvHomeDirKey: servers.DefaultXld.Metadata[servers.XldEnvHomeDirKey],
					servers.XldInfHomeDirKey: servers.DefaultXld.Metadata[servers.XldInfHomeDirKey],
				},
			}},
