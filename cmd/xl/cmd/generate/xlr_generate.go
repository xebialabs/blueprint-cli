...
func init() {
	...
	generateFlags.BoolVarP(&xlrEnvironments, "environments", "e", false, "Add to the generated file all environments")
	generateFlags.BoolVarP(&xlrApplications, "applications", "a", false, "Add to the generated file all the applications in system")
	generateFlags.BoolVarP(&xlrTemplates, "templates", "t", false, "Add to the generated file all the applications in system")
	generateFlags.BoolVarP(&xlrDashboards, "dashboards", "d", false, "Add to the generated file all the applications in system")
	generateFlags.BoolVarP(&xlrConfigurations, "configurations", "c", false, "Add to the generated file all the applications in system")
	generateFlags.BoolVarP(&xlrPermissions, "permissions", "m", false, "Add to the generated file all the applications in system")
	generateFlags.BoolVarP(&xlrRiskProfiles, "riskProfiles", "k", false, "Add to the generated file all the applications in system")
}
